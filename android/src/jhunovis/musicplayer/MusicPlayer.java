...
/** Allmost all of the service stub code is lifted from the API docs of class Service.
 * 
 * @author bon
 *
 */
...
//	}
	...
	public void setPlaylist(List<String> playlist) {
		if ( playlist == null ) mPlaylist = new ArrayList<String>();
		else mPlaylist = playlist;
	}
	...
	public String currentTrack() {
		if ( mPlaylist.isEmpty() )
			return null;
		else return mPlaylist.get(0);
	}

	/*
	 * Service Interface and opration.
	 */
